...
include("../Assets/Connection/Connection.php"); 
 $selqry="select * from tbl_cart c inner join tbl_booking b on b.booking_id=c.booking_id  inner join tbl_user u on u.user_id=b.user_id inner join tbl_product p on p.product_id=c.product_id inner join tbl_shop s on s.shop_id=p.shop_id  where c.cart_id='".$_GET["id"]."'";
  ...
  <button id="cmd" onClick="printDiv('content')" style="float:right;color:#FFF;background:#0C0;border:none;margin:20px;padding:10px;border-radius:10px" >Download Bill</button>
    <section class="main-pd-wrapper" style="width: 1000px; margin: auto" id="content">
        ...
        <table style="width: 100%; table-layout: fixed">
          <tr>
            ...
            >
              ...
              >
              	<span 
                style="color:#0C0;font-size:56px">Eden</span>
                ...
                <p style="font-weight: bold">
                  Toll Free No. :
                  <a href="tel:018001236477" style="color: #109a37"
                    >1800-123-6477</a
                  >
                </p>
              </div>
      ...
      >
        ...
        <tbody>
          <tr>
            ...
            <td><img src="../Assets/Files/User/<?php echo $data["product_image"];?>" width="119" height="92" /></td>
            <td><?php echo $data["product_rate"] ?></td>
            <td><?php echo $data["booking_quantity"] ?></td>
            <td><?php echo $data["product_rate"] * $data["booking_quantity"] ?></td>
          </tr>
        </tbody>
        <tfoot></tfoot>
      </table>
      ...
      <table class="hm-p table-bordered" style="width: 100%; margin-top: 30px">
        ...
        <tr style="background: #0C0;color:white">
          <th>Total Order Value</th>
          <td style="width: 70px; text-align: right; border-right: none">
            <b><?php echo $data["product_rate"] * $data["booking_quantity"] ?></b>
          </td>
