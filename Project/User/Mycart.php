        ...
        <div class="shopping-cart" style="margin-top: 50px"> 
			   ...
			   $res = mysql_query($sel);
                while ($row=mysql_fetch_array($res)) {
                    ...
                    if ($rowpr=mysql_fetch_array($respr)) {
                       $selstock = "select  COALESCE(sum(stock_quantity),0) as stock from tbl_stock where product_id='".$rowpr["product_id"]."'";
            ...
            <div class="product">
                <div class="product-image">
                    <img
                        src="../Assets/Files/User/<?php echo $rowpr["product_image"] ?>"
                        />
                </div>
                ...
                <div class="product-quantity">
                    <input alt="<?php echo $row["cart_id"] ?>" type="number" value="<?php echo $row["booking_quanity"] ?>" min="1" max="<?php echo $rowst["stock"] ?>"/>
                </div>
