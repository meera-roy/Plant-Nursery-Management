...
{
	$sel="select max(booking_id) as id from tbl_booking where user_id='".$_SESSION["userid"]."'";
	$data=mysql_query($sel);
	$row=mysql_fetch_array($data);
	
	$update="update tbl_booking set booking_status=1 where booking_id='".$row["id"]."'";
	mysql_query($update);
	...
	<div class="wrapper">
		...
		<form method="POST">
			...
			<div class="input-group">
				<div class="input-box">
					<h4>Date of Birth</h4>
					<input class="name" type="date" max="<?php echo date("Y-m-d") ?>"  name="txtdate" id="txtdate" >
				</div>
				<div class="input-box">
					<h4>Gender</h4>
			...
			<div class="input-group">
				...
				<div class="input-box">
					<input class="name" type="month" name="txtdate" id="txtdate" min="<?php echo date("Y-m") ?>" placeholder="EXP DATE" required>
