    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            session_start();
				...
				$i=0;
			 $selQry = "select * from tbl_booking b inner join tbl_cart c on b.booking_id=c.booking_id inner join tbl_product p on p.product_id=c.product_id inner join tbl_shop k on k.shop_id=p.shop_id inner join tbl_user u on u.user_id=b.user_id where true and booking_status > 0 and cart_status > 0 and k.shop_id='".$_SESSION["shopid"]."'";
				 ...
				 $selQry = $selQry." and booking_date between '".$_POST["fdate"]."' and '".$_POST["tdate"]."'";
				  ...
				  $rs = mysql_query($selQry);
                   while($data = mysql_fetch_array($rs)) 
				   {
					   ...
					   $amt = $data["product_rate"] * $data["booking_quantity"];
			...
			?>
              <tr>
                 ...
                 <td align="center"><?php echo $data["product_rate"]; ?></td>
                 <td align="center"><?php echo $data["booking_quantity"]; ?></td>
                 ...
                 <?php 
					...
					else if($data["booking_status"]==1 && $data["cart_status"]==2)
					{
						?>
                       Product Packed
					...
					else if($data["booking_status"]==1 && $data["cart_status"]==3)
					{
						?>
                      Product Shipped
                        <?php 
					}
					else if($data["booking_status"]==1 && $data["cart_status"]==4)
					{
						?>
                           Order Completed 
                        <?php 
